...
<script>
	import { listDeliveryAddressByUserId, removeDeliveryAddress } from '@/service/DeliveryAddress';
	...
	export default {
		...
		methods: {
			listDeliveryAddressByUserId() {
				...
				listDeliveryAddressByUserId(this.user.userId).then(response => {
			...
			removeUserAddress(daId) {
				...
				removeDeliveryAddress(daId).then(response => {
